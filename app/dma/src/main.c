...
static void dma_npcx_api_example(const struct shell *shell, size_t argc, char **argv)
{
	sh_ptr = shell;
...
SHELL_STATIC_SUBCMD_SET_CREATE(
	...
	SHELL_CMD_ARG(c3, NULL, "dma c3 init <dev> <channel>", dma_command, 4, 0),
	SHELL_CMD_ARG(ram, NULL, "dma ram <0/1> <1B/1W/1DW/Burst>", dam_ram_to_ram,
		3, 0),
