...
uint8_t aes_plaintext_golden[] __attribute__ ((aligned (4))) = {
...
uint8_t aes_ecb_128_ciphertext_golden[] __attribute__ ((aligned (4))) = {
...
uint8_t aes_ecb_192_ciphertext_golden[] __attribute__ ((aligned (4))) = {
...
uint8_t aes_ecb_256_ciphertext_golden[] __attribute__ ((aligned (4))) = {
...
uint8_t aes_cbc_128_ciphertext_golden[] __attribute__ ((aligned (4))) = {
...
uint8_t aes_cbc_192_ciphertext_golden[] __attribute__ ((aligned (4))) = {
...
uint8_t aes_cbc_256_ciphertext_golden[] __attribute__ ((aligned (4))) = {
...
uint8_t aes_ctr_128_ciphertext_golden[] __attribute__ ((aligned (4))) = {
...
uint8_t aes_ctr_192_ciphertext_golden[] __attribute__ ((aligned (4))) = {
...
uint8_t aes_ctr_256_ciphertext_golden[] __attribute__ ((aligned (4))) = {
...
uint8_t aes_gcm_128_ciphertext_golden[] __attribute__ ((aligned (4))) = {
...
uint8_t aes_gcm_192_ciphertext_golden[] __attribute__ ((aligned (4))) = {
...
uint8_t aes_gcm_256_ciphertext_golden[] __attribute__ ((aligned (4))) = {
...
uint8_t aes_ad[] __attribute__ ((aligned (4))) = {
0xfe, 0xed, 0xfa, 0xce, 0xde, 0xad, 0xbe, 0xef,
0xfe, 0xed, 0xfa, 0xce, 0xde, 0xad, 0xbe, 0xef,
0xab, 0xad, 0xda, 0xd2
};

uint8_t aes_nonce[] __attribute__ ((aligned (4))) = {
0xca, 0xfe, 0xba, 0xbe, 0xfa, 0xce, 0xdb, 0xad
};

uint8_t aes_gcm_128_tag_golden[AES_BLOCK_SIZE] __attribute__ ((aligned (4))) = {
0xF6, 0xF1, 0x09, 0x17, 0x64, 0x90, 0x06, 0x30,
0xA1, 0x93, 0x65, 0x24, 0x07, 0x77, 0xE7, 0x26,
};

uint8_t aes_gcm_192_tag_golden[AES_BLOCK_SIZE] __attribute__ ((aligned (4))) = {
0xD4, 0x8F, 0xA5, 0xBE, 0x30, 0x6A, 0xA1, 0xD9,
0x14, 0x23, 0x94, 0x2A, 0xB3, 0x7E, 0x44, 0x9B,
};

uint8_t aes_gcm_256_tag_golden[AES_BLOCK_SIZE] __attribute__ ((aligned (4))) = {
